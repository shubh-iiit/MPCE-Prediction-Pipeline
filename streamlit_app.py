...
def load_models_from_huggingface():
    ...
    try:
        ...
        try:
            ...
            st.write(f"✓ Classifier downloaded")
        except Exception as e:
            st.write(f"⚠ Classifier path issue: {e}")
            st.write("Trying alternative path...")
            clf_path = hf_hub_download(
                repo_id=MODEL_REPO,
        ...
        try:
            ...
            st.write(f"✓ Regressor downloaded")
        except Exception as e:
            st.write(f"⚠ Regressor path issue: {e}")
            st.write("Trying alternative path...")
            reg_path = hf_hub_download(
                repo_id=MODEL_REPO,
